...
const VerifyPaymentPage = () => {
    ...
    // --- FIX: authHeaders logic moved INSIDE the useEffect ---

    useEffect(() => {
        // --- FIX: Moved this logic from outside to inside the hook ---
        ...
        axios.get('http://localhost:4000/api/orders/confirm', {
            params: { session_id },
            headers: authHeaders // Use the headers defined inside the effect
        })
            .then(() => {
            ...
            .catch(err => {
                ...
                clearCart(false); // Assuming clearCart can handle this
            });
            
    // --- FIX: Removed `authHeaders` from the dependency array ---
